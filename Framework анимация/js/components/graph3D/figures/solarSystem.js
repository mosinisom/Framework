Figure.prototype.solarSystem = (count = 40, R = 15, point = new Point(0, 0, 0), color = "#ff0000", animation, turn, center) => {
    const points = [];
    const edges = [];
    const polygons = [];
    ...
    return new Subject(points, edges, polygons, animation, center, turn);
}